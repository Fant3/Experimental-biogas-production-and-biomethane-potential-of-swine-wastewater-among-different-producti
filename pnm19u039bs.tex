...
where $y$ is the cumulative biogas production (mL.gVS\textsuperscript{−1}), $A$ is the maximum biogas production potential (mL.gVS\textsuperscript{−1}), $μ_m$ the maximum rate of methane production rate ((mL.gVS\textsuperscript{−1})d\textsuperscript{−1}), e: exp(1), $λ$: lag-phase (days), $t$ is the incubation time (days), and $d v: shape coefficient.