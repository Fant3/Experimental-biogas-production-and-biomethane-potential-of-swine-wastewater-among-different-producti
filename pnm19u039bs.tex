...
where $y$ is the cumulative biogas production (mL.gVS\textsuperscript{−1}), $A$ is the maximum specific methane production potential (mLCH4 gVS−1), μm: max. specific methane production rate (mLCH4 gVS−1 d−1), e: exp(1), λ: lag-phase (days), t:incubation time (days), v: shape coefficient.